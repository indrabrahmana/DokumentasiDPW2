        ...
        <div class="ltn__utilize-menu-inner ltn__scrollbar">
            ...
            <div class="mini-cart-footer">
                ...
                <div class="btn-wrapper">
                    <a href="{{('cart')}}/#cart" class="theme-btn-1 btn btn-effect-1">Lihat Keranjang</a>
                    <a href="{{('cart')}}/#cart" class="theme-btn-2 btn btn-effect-2">Checkout</a>
                </div>
                                    ...
                                    <div class="col-xl-4 col-sm-6 col-6">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="product-details.html"><img src="{{url('public')}}/img/product/1.jpg" alt="#"></a>
